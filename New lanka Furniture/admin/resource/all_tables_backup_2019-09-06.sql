...
# Dumping data for table db_nuzrath.logs: ~2 rows (approximately)
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
INSERT INTO `logs` (`user_id`, `access_code`, `user_grp`) VALUES
	('admin@admin.com', 'PWtU9AEctxxgg', 'admin'),
	('nuz@kadella.com', 'PWtU9AEctxxgg', 'admin'),
	('staff@staff.com', 'PWtU9AEctxxgg', 'staff');
/*!40000 ALTER TABLE `logs` ENABLE KEYS */;


# Dumping structure for table db_nuzrath.logs_old
CREATE TABLE IF NOT EXISTS `logs_old` (
  `user_id` varchar(80) NOT NULL,
  `access_code` varchar(80) NOT NULL,
  `user_grp` varchar(20) NOT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='maintains the usernames and passwords of user accounts';

# Dumping data for table db_nuzrath.logs_old: ~3 rows (approximately)
/*!40000 ALTER TABLE `logs_old` DISABLE KEYS */;
INSERT INTO `logs_old` (`user_id`, `access_code`, `user_grp`) VALUES
	('admin@admin.com', 'admin', 'admin'),
	('nuz@kadella.com', 'admin', 'admin'),
	('staff@staff.com', 'admin', 'staff');
/*!40000 ALTER TABLE `logs_old` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `property` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='property master table';

# Dumping data for table db_nuzrath.property: ~17 rows (approximately)
...
INSERT INTO `property` (`pid`, `title`, `description`, `location`, `price`, `picture`) VALUES
	...
	(25, 'House', 'dfsdf', 'sdfsd', 4534540, 'default.jpg'),
	(27, 'Sample Pro', 'test', 'test', 45543500, '27_12944808422054485949807479654.jpg'),
	(28, 'test 2', 'sdfdsf', 'kandy', 8500000, '28_8723721031568293451890631361.jpg'),
	(29, 'new new new house', 'sample post', 'kandy', 8500000, '29_8819843113263243131509407642.jpg');
...
CREATE TABLE IF NOT EXISTS `property_archive` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='property master table';
...
INSERT INTO `property_archive` (`pid`, `title`, `description`, `location`, `price`, `picture`) VALUES
	...
	(26, 'New Luxury House for Sale', 'House for sale, \r\nfeatures...', 'Colombo', 290000000, '26_111698154810172310061063919');
