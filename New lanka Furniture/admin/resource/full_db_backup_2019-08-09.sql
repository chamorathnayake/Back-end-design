...
CREATE TABLE IF NOT EXISTS `property` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='property master table';

# Dumping data for table db_nuzrath.property: ~12 rows (approximately)
